...
#define PWM_OUTPUT_MOTOR_L 6 // Pin 4 où sort le pwm du moteur 2
#define INPUT_4_MOTOR_L   10   // Pin 9 pour un sens
#define INPUT_3_MOTOR_L    11  // Pin 3 pour l'autre sens

#define PWM_OUTPUT_MOTOR_R 5 // Pin 7 où sort le pwm du moteur 1
#define INPUT_2_MOTOR_R    9  // Pin 10 pour un sens
#define INPUT_1_MOTOR_R    3  // Pin 11 pour l'autre sens
