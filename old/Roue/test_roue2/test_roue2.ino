...
int pwm_gauche = 0;  //Varie entre 0 et 255 pour fournir un PWM au moteur
int pwm_droite = 0; //Varie entre 0 et 255 pour fournir un PWM au moteur
...
void receiveEvent(int howMany)
{
  ...
  x = (int8_t)Wire.read();// de -127 à 128
  y = (int8_t)Wire.read();// de -127 à 128
}
/////////////////////////////////////////////////////////////
